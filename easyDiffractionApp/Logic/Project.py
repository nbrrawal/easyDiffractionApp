...
class ProjectLogic(QObject):
    ...
    def _loadProject(self):
        ...
        if 'experiments' in descr:
            ...
            self.parent.proxy.parameters._data.experiments[0].x = np.array(descr['experiments'][0])
            self.parent.proxy.parameters._data.experiments[0].y = np.array(descr['experiments'][1])
            self.parent.proxy.parameters._data.experiments[0].e = np.array(descr['experiments'][2])
            self.parent.l_experiment._experiment_data = self.parent.proxy.parameters._data.experiments[0]
    ...
    def saveProject(self):
        ...
        if self.parent.proxy.parameters._data.experiments:
            experiments_x = self.parent.proxy.parameters._data.experiments[0].x
            experiments_y = self.parent.proxy.parameters._data.experiments[0].y
            experiments_e = self.parent.proxy.parameters._data.experiments[0].e
